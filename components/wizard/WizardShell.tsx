  ...
  return (
    <section className="grid md:grid-cols-[40%_60%] min-h-[100svh] pt-20">
      <aside className="relative hidden md:block">
        <Image src="https://images.unsplash.com/photo-1517732306149-e8f829eb588a?w=1200&auto=format&fit=crop&q=80" alt="" aria-hidden fill className="object-cover opacity-50" sizes="40vw" />
